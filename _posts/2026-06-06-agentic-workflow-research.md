...
## The project: SimpleVault

SimpleVault is a native Apple app (iOS + macOS) for securing family assets, documents, photos, and contacts with end-to-end encryption tied to a trusted Apple account. Think of it as a personal vault for things that aren't just files, they're your legacy.
...
State lives in per-EPIC discussion files. Any EPIC can be reopened without affecting others. A real example from SimpleVault:
